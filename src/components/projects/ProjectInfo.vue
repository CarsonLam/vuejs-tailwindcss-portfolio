...
export default {
  props: ["projectInfo", "projectInfoContent"],
...
<template>
  <div class="block sm:flex gap-0 sm:gap-10 mt-14">
    ...
    <div class="w-full sm:w-1/3 text-left">
      ...
      <div class="mb-7">
        ...
        <ul class="leading-loose">
          <li
            v-for="info in projectInfoContent.companyInfos"
            :key="info"
      ...
      <div class="mb-7">
        ...
        >
          {{ projectInfoContent.objectivesDetails }}
        </p>
      </div>
      ...
      <div class="mb-7">
        <p
          class="font-general-medium text-2xl text-ternary-dark dark:text-ternary-light mb-2"
        >
          {{ projectInfoContent.technologies[0].title }}
        </p>
        <p
          class="font-general-regular text-primary-dark dark:text-ternary-light"
        >
          {{ projectInfoContent.technologies[0].techs.join(", ") }}
        </p>
      </div>
      ...
      <div>
        ...
        <div class="flex items-center gap-3 mt-5">
          <a
            v-for="social in projectInfoContent.socialSharings"
            :key="social.id"
            :href="social.url"
            target="__blank"
    ...
    <div class="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
      ...
      <p
        v-for="projectDetail in projectInfoContent.projectDetails"
